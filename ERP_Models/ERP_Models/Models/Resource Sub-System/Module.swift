...
class Module: Resource {
    ...
    init (moduleName name : NSString, withDescription description : NSString, moduleCreators creators : [HumanResource], category : NSString, entity: NSManagedObject? = nil)
    {
    ...
    func addMaintenance (TitleIs title : NSString, withMaintainers maintainers : [HumanResource], description : NSString, andDate date: NSString)
    {
        ...
        (myEntity as! ModuleEntity).maintenances?.setByAddingObject(newMaintenance.myEntity!)
